 ...
 *      DEFINES
 *********************/
#define SOFT_TIMER_LOG_EN           1       /*Inside log enable, 0: diable; 1: enable*/
...
#define SOFT_TIMER_CUSTOM_COUNT     (32)    /*Timer max count*/
...
#else
#   define SOFT_TIMER_CUSTOM_GET_TICK (custom_get_time())
#endif
#else
